...
- a file **dropped anywhere on the page** — several at once are offered one after another
...
Alongside the file, the Download dialog offers a **Link**. It is copied to the clipboard, and the song travels inside it — nothing is uploaded, and nothing is fetched when it is opened. Tapping it opens the import preview on any device, installed app or browser tab, online or not.
