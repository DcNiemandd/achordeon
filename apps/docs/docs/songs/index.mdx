...
description: 'Write lyrics with chords and let Achordeon lay the sheet out for you. Search, sort and favourite your library, one song to a page.'
---
...
<Image
  alt="Showcase song render"
  src="/img/screenshot-song-render.png"
  isDesign
  shadow
/>
...
- duplicate
- make favorite
- [download](/export-import/index.mdx), which is also where [export](/export-import/index.mdx) lives, as a choice in its dialog
- edit
...
You can open song editing by clicking on the edit option or by double-clicking on the song. On a phone one tap on the song is enough - there is no second pane there for a single click to preview into. Detailed guide for song editing is on the [next page](./editing.mdx).
